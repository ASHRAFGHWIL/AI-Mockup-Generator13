...
// Beanie Types
export type BeanieStyle = 'cuffed' | 'slouchy' | 'pom_pom' | 'angora_pearl' | 'chenille_heart_knit' | 'slouchy_cashmere' | 'luxe_faux_fur_pompom' | 'satin_lined_slouchy';
...
// Pillow Types
export type PillowStyle = 'square_cotton' | 'lumbar_linen' | 'round_velvet' | 'plush_faux_fur_heart' | 'satin_with_lace_trim' | 'round_velvet_with_tassel' | 'silk_bolster' | 'ruffled_linen_square';
